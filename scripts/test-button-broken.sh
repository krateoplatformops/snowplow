...
kubectl apply -f testdata/issues/button-broken/widgets.templates.krateo.io_buttons.yaml
...
kubectl apply -f testdata/issues/button-broken/button-broken.yaml
